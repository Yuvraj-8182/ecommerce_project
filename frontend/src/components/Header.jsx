...
const Header = () => {
  ...
  const toggkeMenu = () => setmenuOpened(!menuOpened);
  return (
    <header className="fixed top-0 left-0  m-auto max_padd_container w-full bg-white ring-1 ring-slate-900/5 z-10">
        <div className="px-4 flexBetween py-3 max-xs:px-2">
            ...
            {/*Navbar*/}
            <Navbar containerStyles={"hidden md:flex gap-x-5 xl:gap--10 medium-15"} />
             {/*Navbar mobile*/}
            ...
            <div className='flexBetween sm:gap-x-2 bold-16'>
              ...
              <div className='flexBetween sm:gap-x-6'>
                <NavLink to={"cart-page"} className={"flex"}><FaOpencart className='p-1 h-8 w-8 ring-slate-900/30 ring-1 rounded-full'/><span className='relative flexCenter w-5 h-5 rounded-full bg-secondary text-white meduim-14 -top-2'>0</span></NavLink>
