  ...
  return (
    <section className='max_padd_container pt-28'>
        <table className='w-full mx-auto'>
            ...
            <tbody>
                {all_products.map((e) => {
                    if (cartItems[e.id] > 0)
                    {
                           return <tr key={e.id} className='border-b border-slate-900/20 text-gray-40 p-6 medium-14 text-center'>
        ...
        <div className='flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]'>
            ...
            <h1 className='bold-20'>Summary</h1>
             <div >
             ...
             <div className='flex flex-col gap-10'>
                ...
                <div className='flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10'>
                    <input type="text" placeholder='Copon code' className='bg-transparent border-none outline-none'/>
